...
import { archiveCustomerAction, createCustomerAction, updateCustomerAction } from "@/app/actions/f2";
import type { CustomerRecord } from "@/domain/sales";

type Fields = { name: string; whatsapp: string; address: string; notes: string };
